...
namespace C__Advance_Concept
{
    internal class OOP
    {
        private void definition()
        {
            ...
            //  So this lead us to the first fundamental concept of object oriented programming ;

            string Abstraction = "" +
                "abstraction mean simplify reality, it means displaying only essential information and hiding the details" +
                "for example a person";
                /*
                  "for example, a person can be represented as an object in a program. We don't need to know all the intricate details about a person, such as the exact composition of their cells or the complex biological processes within them. Instead, we focus on the essential attributes and behaviors that define a person in the context of our software."

               "In the world of object-oriented programming, abstraction allows us to model real-world entities by capturing their essential characteristics and interactions. It helps us create a simplified representation of complex systems, making it easier to understand and work with."
